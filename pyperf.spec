...
%prep
%setup -q -n pyperf-2.1.0
cd %{_builddir}/pyperf-2.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611251564
...
cp %{_builddir}/pyperf-2.1.0/COPYING %{buildroot}/usr/share/package-licenses/pyperf/0c885fb5d06bf65019b498d9cef9641983dd58ad
