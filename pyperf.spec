...
Source0  : https://files.pythonhosted.org/packages/0e/68/605d68755c8c5d88c7c1c798b6b82f8c13d8435c8ef1cb224c436811b99b/pyperf-1.7.1.tar.gz
...
%prep
%setup -q -n pyperf-1.7.1
cd %{_builddir}/pyperf-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583778493
...
cp %{_builddir}/pyperf-1.7.1/COPYING %{buildroot}/usr/share/package-licenses/pyperf/0c885fb5d06bf65019b498d9cef9641983dd58ad
