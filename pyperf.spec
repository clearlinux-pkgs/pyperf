...
Source0  : https://files.pythonhosted.org/packages/84/49/8a5fb8eed0c600e763b33b6d4e62ffc7b0b9b13b03a69e7969fea5985f3a/pyperf-2.0.0.tar.gz
...
%prep
%setup -q -n pyperf-2.0.0
cd %{_builddir}/pyperf-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585076772
...
cp %{_builddir}/pyperf-2.0.0/COPYING %{buildroot}/usr/share/package-licenses/pyperf/0c885fb5d06bf65019b498d9cef9641983dd58ad
